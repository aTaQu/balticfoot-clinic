...
export function BookingReceivedEmail({ patientName, serviceName, date, time, clinicPhone }: BookingEmailData) {
  return (
    <Html lang="lt">
      <Head />
      <Preview>Jūsų vizito užklausa gauta — Baltic Foot</Preview>
      <Body style={s.body}>
        <Container style={s.container}>
          ...
          <Section>
            ...
            <Text style={s.text}>
              gavome jūsų užklausą dėl vizito. Netrukus ją peržiūrėsime ir
              patvirtinsime arba susisieksime dėl tinkamiausio laiko.
            </Text>
